...
export const ApiDocumentation: React.FC = () => {
  ...
  const endpoints = [
    ...
    { path: '/api/v1/status', method: 'GET', desc: 'Get bot running state, server IP & engine info' },
    ...
    { path: '/api/v1/entry', method: 'POST', desc: 'Open a real LONG or SHORT Futures position' },
    { path: '/api/v1/forceexit', method: 'POST', desc: 'Close the active Futures position with reduceOnly' },
