        ...
        <div className="flex items-center justify-between md:justify-end gap-2 pt-1 md:pt-0 border-t md:border-t-0 border-[#1e232f]/60">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center bg-[#1e232f] hover:bg-slate-700 text-slate-300 border border-slate-700/60 px-2 py-1.5 rounded-lg font-medium text-xs transition shrink-0 gap-1"
              title="Borsa API Ayarları"
            >
              <Settings className="w-3.5 h-3.5" />
              <span className="text-[11px] sm:text-xs">Borsa</span>
            </button>
          </div>

          {/* USDT Balance Badge */}
          <div className="flex items-center space-x-1.5 bg-[#0b0e14] border border-[#2a3142] px-2.5 py-1.5 rounded-lg shrink-0">
